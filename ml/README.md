...
- It reads five reference tables — `exercises`, `equipment`,
  `exercise_equipment_requirements`, `exercise_contraindications`,
  `exercise_categories` — with a read-only account. It never reads a user row:
  every user field arrives in the request body.
