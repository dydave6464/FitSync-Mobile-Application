...
void main() {
  testWidgets(
    'seven cells are offered, keyed weekday.1 through weekday.7, and no eighth',
    (tester) async {
  ...
  testWidgets(
    'a selected day renders selected and an unselected one does not',
    (tester) async {
